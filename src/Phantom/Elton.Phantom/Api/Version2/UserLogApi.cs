...
namespace Elton.Phantom.Api.Version2
{
    ...
    public interface IUserLogApi
    {
        ...
        UserLog GetUserLog (string nextCursor = null, int? count = null);
        ...
        ApiResponse<UserLog> GetUserLogWithHttpInfo (string nextCursor = null, int? count = null);
        ...
        System.Threading.Tasks.Task<UserLog> GetUserLogAsync (string nextCursor = null, int? count = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<UserLog>> GetUserLogAsyncWithHttpInfo (string nextCursor = null, int? count = null);
