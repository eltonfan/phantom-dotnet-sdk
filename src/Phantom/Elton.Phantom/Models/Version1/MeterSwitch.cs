...
namespace Elton.Phantom.Models.Version1
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeterSwitch :  IEquatable<MeterSwitch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeterSwitch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MeterSwitch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MeterSwitch" /> class.
        /// </summary>
        ...
        public MeterSwitch(int? Id = default(int?), string DeviceIdentifier = default(string), string Name = default(string), int? UserId = default(int?), int? HouseId = default(int?), int? TodayEnergy = default(int?), int? DeviceIp = default(int?), int? RouterId = default(int?), string Connectivity = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for MeterSwitch and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("DeviceIdentifier is a required property for MeterSwitch and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for MeterSwitch and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (UserId == null)
            {
                throw new InvalidDataException("UserId is a required property for MeterSwitch and cannot be null");
            }
            else
            {
                this.UserId = UserId;
            ...
            if (HouseId == null)
            {
                throw new InvalidDataException("HouseId is a required property for MeterSwitch and cannot be null");
            }
            else
            {
            ...
            if (TodayEnergy == null)
            {
                throw new InvalidDataException("TodayEnergy is a required property for MeterSwitch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("Connectivity is a required property for MeterSwitch and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MeterSwitch);
        }

        /// <summary>
        /// Returns true if MeterSwitch instances are equal
        /// </summary>
        /// <param name="input">Instance of MeterSwitch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeterSwitch input)
        {
            if (input == null)
                return false;
