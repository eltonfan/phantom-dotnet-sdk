...
namespace Elton.Phantom.Models.Version1
{
    ...
    /// </summary>
    [DataContract]
    public partial class FreshAirMachine :  IEquatable<FreshAirMachine>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FreshAirMachine" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FreshAirMachine() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FreshAirMachine" /> class.
        /// </summary>
        ...
        public FreshAirMachine(int? Id = default(int?), string DeviceIdentifier = default(string), string Name = default(string), int? UserId = default(int?), int? HouseId = default(int?), GmFilter Filters = default(GmFilter), string DeviceCategory = default(string), string Capability = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for FreshAirMachine and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("DeviceIdentifier is a required property for FreshAirMachine and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for FreshAirMachine and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (UserId == null)
            {
                throw new InvalidDataException("UserId is a required property for FreshAirMachine and cannot be null");
            }
            else
            {
                this.UserId = UserId;
            ...
            if (Filters == null)
            {
                throw new InvalidDataException("Filters is a required property for FreshAirMachine and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FreshAirMachine {\n");
        ...
        {
            return this.Equals(input as FreshAirMachine);
        }

        /// <summary>
        /// Returns true if FreshAirMachine instances are equal
        /// </summary>
        /// <param name="input">Instance of FreshAirMachine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FreshAirMachine input)
        {
            if (input == null)
                return false;
