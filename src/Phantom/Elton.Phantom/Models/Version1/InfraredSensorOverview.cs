...
namespace Elton.Phantom.Models.Version1
{
    ...
    /// </summary>
    [DataContract]
    public partial class InfraredSensorOverview :  IEquatable<InfraredSensorOverview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InfraredSensorOverview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InfraredSensorOverview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InfraredSensorOverview" /> class.
        /// </summary>
        ...
        public InfraredSensorOverview(int? Id = default(int?), string Name = default(string), string DeviceIdentifier = default(string), int? Position = default(int?), string Connectivity = default(string), bool? Active = default(bool?), int? C0 = default(int?), int? C1 = default(int?), int? C2 = default(int?), int? C3 = default(int?), int? C4 = default(int?), int? C5 = default(int?), int? C6 = default(int?), int? C7 = default(int?), int? HouseId = default(int?), bool? OwnDevice = default(bool?))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            {
                throw new InvalidDataException("DeviceIdentifier is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("Connectivity is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
            ...
            if (Active == null)
            {
                throw new InvalidDataException("Active is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.Active = Active;
            ...
            if (C0 == null)
            {
                throw new InvalidDataException("C0 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C0 = C0;
            ...
            if (C1 == null)
            {
                throw new InvalidDataException("C1 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C1 = C1;
            ...
            if (C2 == null)
            {
                throw new InvalidDataException("C2 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C2 = C2;
            ...
            if (C3 == null)
            {
                throw new InvalidDataException("C3 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C3 = C3;
            ...
            if (C4 == null)
            {
                throw new InvalidDataException("C4 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C4 = C4;
            ...
            if (C5 == null)
            {
                throw new InvalidDataException("C5 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C5 = C5;
            ...
            if (C6 == null)
            {
                throw new InvalidDataException("C6 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C6 = C6;
            ...
            if (C7 == null)
            {
                throw new InvalidDataException("C7 is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
                this.C7 = C7;
            ...
            if (HouseId == null)
            {
                throw new InvalidDataException("HouseId is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
            ...
            if (OwnDevice == null)
            {
                throw new InvalidDataException("OwnDevice is a required property for InfraredSensorOverview and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InfraredSensorOverview {\n");
        ...
        {
            return this.Equals(input as InfraredSensorOverview);
        }

        /// <summary>
        /// Returns true if InfraredSensorOverview instances are equal
        /// </summary>
        /// <param name="input">Instance of InfraredSensorOverview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InfraredSensorOverview input)
        {
            if (input == null)
                return false;
