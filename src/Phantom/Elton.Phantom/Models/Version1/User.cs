...
namespace Elton.Phantom.Models.Version1
{
    ...
    public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        public User(int? Id = default(int?), string UserUniqId = default(string), string Phone = default(string), string Name = default(string), string Email = default(string), string HomeLong = default(string), string HomeLat = default(string), string HomeInfo = default(string), string HomeGaodeLong = default(string), string HomeGaodeLat = default(string), int? HomeComingScenarioId = default(int?), int? HomeLeavingScenarioId = default(int?), string DeviceCount = default(string), int? SleepTime = default(int?), int? WakeTime = default(int?), DateTime? CreatedAt = default(DateTime?), DateTime? UpdatedAt = default(DateTime?), string Type = default(string), string DeprecatedToken = default(string), string Nickname = default(string), string Avatar = default(string), string VoiceMessageUrl = default(string), string HasIermuUser = default(string))
        {
            ...
            if (UserUniqId == null)
            {
                throw new InvalidDataException("UserUniqId is a required property for User and cannot be null");
            }
            else
            {
            ...
            if (DeviceCount == null)
            {
                throw new InvalidDataException("DeviceCount is a required property for User and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DeprecatedToken is a required property for User and cannot be null");
            }
            else
            {
