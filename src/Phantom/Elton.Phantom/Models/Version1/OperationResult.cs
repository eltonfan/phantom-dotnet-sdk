...
namespace Elton.Phantom.Models.Version1
{
    ...
    public partial class OperationResult :  IEquatable<OperationResult>, IValidatableObject
    {
        ...
        public OperationResult(bool? Success = default(bool?), string Reason = default(string))
        {
            // to ensure "Success" is required (not null)
            if (Success == null)
            {
                throw new InvalidDataException("Success is a required property for OperationResult and cannot be null");
            }
            else
            {
